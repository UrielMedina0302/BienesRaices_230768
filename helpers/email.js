...
const emailAfterRegister = async (newUserData)=>{
    ...
    await transport.sendMail({
       ...
       <br>
       <p>Ya solo necesitamos confirmes la cuenta que creaste, dando click a la siguiente liga:  <a href="${process.env.BACKEND_DOMAIN}:${process.env.BACKEND_PORT ?? 3000}/auth/accountConfirm/${token}">Confrimar cuenta</a></p> 
       <br>
